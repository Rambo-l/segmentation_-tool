...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "语义分割工具"))
        ...
        self.sel_jsonjpg_file.setText(_translate("MainWindow", "点击选择JSON-JPG文件夹"))
        ...
        self.sel_JPG_file.setText(_translate("MainWindow", "点击选择JPG文件夹"))
        self.sel_PNG_file.setText(_translate("MainWindow", "点击选择PNG文件夹"))
